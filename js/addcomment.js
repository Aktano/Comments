...
const formSubmit = (e) => {
    ...
    if (parsedDate.toString() === 'Invalid Date') parsedDate = currentDate // если введенная дата некорректна или не введена, используем текущую дату
    ...
    let comment = {
        ...
        date: `${parsedDateFormat[2]} ${parsedDateFormat[1]}, ${parsedDateFormat[3]}, ${currentDateFormat[4]}`,
    }
